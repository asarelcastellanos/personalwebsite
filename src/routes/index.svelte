    ...
    <div class="container px-6 py-10 mx-auto">
        ...
        <div class="grid grid-cols-1 gap-8 pt-14 mt-8 xl:mt-12 xl:gap-16 md:grid-cols-2 xl:grid-cols-3">
            <div class="space-y-3">
                ...
                <h1 class="text-2xl font-semibold text-gray-700 capitalize dark:text-white">Project 1</h1>
            ...
            <div class="space-y-3">
                ...
                <h1 class="text-2xl font-semibold text-gray-700 capitalize dark:text-white">Project 2</h1>
            ...
            <div class="space-y-3">
                ...
                <h1 class="text-2xl font-semibold text-gray-700 capitalize dark:text-white">Project 3</h1>
            ...
            <div class="space-y-3">
                ...
                <h1 class="text-2xl font-semibold text-gray-700 capitalize dark:text-white">Project 4</h1>
